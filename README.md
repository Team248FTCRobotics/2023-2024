...
This repository contains the Team 248 FTC SDK for the CENTERSTAGE (2023-2024) competition season.

## Welcome!
This GitHub repository contains the source code that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, download/clone the entire project to your local computer.

## How to push new changes in Android Studio: <br>
...
# Recent Changes and Todo:

Test the robot and finish autonomous, check motors and final variables.
